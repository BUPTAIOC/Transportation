...
import copy
from MRL_Sioux0.On_CB_model.on_magent_model import MA_CB_RP_Sioux0, CB_Encoder
    ...
    for batch_idx, batch in enumerate(data_loader):
        ...
        if save_dir == 'test':
            ...
            reward, value_list = reward_fn(static, tour_indices, travel_time_G, all_station, update_constraint,
                                           up_station, update_dynamic, all_method_max_load, all_method_max_time, AGENT_SIZE-1)  # 奖励
...
def train(actor, critic, task, num_nodes, train_data, valid_data, reward_fn,
    ...
    AGENT_SIZE = 4 # Number of agents=(AGENT_SIZE-1)
...
def train_pdptw(args, up_station, all_station, travel_time_G, Loc_x, Loc_y, up_down_index, depot, home_id, work_id, max_loc_x, max_loc_y):
    Loss_list, Reward_list = [], []
    from MRL_Sioux0.On_CB_tasks import on_magent_pdptw
    from MRL_Sioux0.On_CB_tasks.on_magent_pdptw import CustomizedBusDataset
    ...
    # actor_test = MA_CB_RP_Sioux0(STATIC_SIZE,
    #                         DYNAMIC_SIZE,
    #                         args.hidden_size,
    #                         AGENT_SIZE,
    #                         train_data.update_dynamic,
