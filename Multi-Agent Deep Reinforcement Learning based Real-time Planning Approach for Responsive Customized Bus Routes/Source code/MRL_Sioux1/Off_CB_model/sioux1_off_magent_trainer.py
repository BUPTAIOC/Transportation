...
import copy
from MRL_Sioux1.Off_CB_model.off_magent_model import MA_CB_RP_Sioux1, CB_Encoder
...
class StateCritic(nn.Module):
    ...
    def forward(self, static, dynamic1, dynamic2, dynamic3, dynamic4, dynamic5):
        ...
        dynamic_hidden4 = self.dynamic_encoder2(dynamic4)
        dynamic_hidden5 = self.dynamic_encoder3(dynamic5)
...
def train_pdptw(args, up_station, all_station, travel_time_G, Loc_x, Loc_y, up_down_index, depot, home_id, work_id, max_loc_x, max_loc_y):
    Loss_list, Reward_list = [], []
    from MRL_Sioux1.Off_CB_tasks import off_magent_pdptw
    from MRL_Sioux1.Off_CB_tasks.off_magent_pdptw import CustomizedBusDataset
