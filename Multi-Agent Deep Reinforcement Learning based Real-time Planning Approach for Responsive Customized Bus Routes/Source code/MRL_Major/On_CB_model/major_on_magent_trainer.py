...
import copy
from MRL_Major.On_CB_model.on_magent_model import MA_CB_RP_Major, CB_Encoder
...
def train_pdptw(args, up_station, all_station, travel_time_G, Loc_x, Loc_y, up_down_index, depot, home_id, work_id, max_loc_x, max_loc_y):
    Loss_list, Reward_list = [], []
    from MRL_Major.On_CB_tasks import on_magent_pdptw
    from MRL_Major.On_CB_tasks.on_magent_pdptw import CustomizedBusDataset
    ...
    # actor_test = MA_CB_RP_Major(STATIC_SIZE,
    #                         DYNAMIC_SIZE,
    #                         args.hidden_size,
    #                         AGENT_SIZE,
    #                         train_data.update_dynamic,
